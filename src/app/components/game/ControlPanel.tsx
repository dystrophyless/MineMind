...
export function ControlPanel({ difficulty, onDifficultyChange, time, minesLeft, accuracy, status, onRestart }: Props) {
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <button onClick={onRestart} className="w-full rounded-xl py-3 flex items-center justify-center gap-2 transition-all duration-200 hover:brightness-110 active:scale-95" style={{ background: "var(--mm-action-bg)", color: "var(--mm-action-fg)", fontSize: "14px", fontWeight: 700, fontFamily: "var(--font-mabry)", boxShadow: "var(--mm-action-shadow)" }}>
      ...
      <div className="rounded-xl p-4" style={{ background: "var(--mm-pro-bg)", border: "1px solid rgba(155,114,239,0.25)" }}>
        ...
        <button className="w-full rounded-lg py-2 transition-all duration-200 hover:brightness-110" style={{ background: "linear-gradient(135deg, var(--mm-purple), #7B52EF)", color: "#fff", fontSize: "12px", fontWeight: 700, fontFamily: "var(--font-mabry)", boxShadow: "0 4px 12px rgba(155,114,239,0.35)" }}>
